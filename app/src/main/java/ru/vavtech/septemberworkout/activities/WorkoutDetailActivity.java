    ...
    private void addListeners() {
        ...
        saveRecordButton.setOnClickListener (new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int oldWeight=Integer.parseInt(recordWeight.getText().toString());
                int newWeight=Integer.parseInt(weight.getText().toString());
                int oldRepsCount = Integer.parseInt(recordRepsCount.getText().toString());
                int newRepsCount = Integer.parseInt(repsCountEditText.getText().toString());
                if(newWeight*newRepsCount>oldWeight*oldRepsCount) {
